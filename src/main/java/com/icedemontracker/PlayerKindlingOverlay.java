...
public class PlayerKindlingOverlay extends Overlay
{
	...
	private final IceDemonTrackerPlugin plugin;
	private final IceDemonTrackerConfig config;

	@Inject
	private PlayerKindlingOverlay(Client client, IceDemonTrackerPlugin plugin, IceDemonTrackerConfig config)
	{
		this.client = client;
		this.plugin = plugin;
		this.config = config;
