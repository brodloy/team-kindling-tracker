...
<img src="banner.png" alt="Ice Demon Tracker" width="100%" />
...
Once published, search **"Ice Demon Tracker"** in RuneLite's **Plugin Hub** and
...
3. Add a file named `plugins/ice-demon-tracker` (no extension) containing:
   ```
